...
typedef SWIFT_ENUM(NSInteger, YCBLEConnectType, closed) {
/// 绑定页的连接，可以连接所有设备
...
typedef SWIFT_ENUM(NSInteger, YCBLEMeasureFlag, closed) {
...
typedef SWIFT_ENUM(NSInteger, YCBLEState, closed) {
/// 正常打开
  YCBLEStateValid = 0,
/// 未知状态
  YCBLEStateUnknown = 1,
