...
SWIFT_CLASS("_TtC10ShecareSDK16LayoutConstraint")
@interface LayoutConstraint : NSLayoutConstraint
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface LayoutConstraint (SWIFT_EXTENSION(ShecareSDK))
...
SWIFT_CLASS("_TtC10ShecareSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(ShecareSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(ShecareSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(ShecareSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC10ShecareSDK12TaskDelegate")
